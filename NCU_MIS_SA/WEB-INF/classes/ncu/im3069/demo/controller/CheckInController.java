...
public class CheckInController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isDamaged=jso.getBoolean("isDamaged");
        /** 取出經解析到JSONObject之Request參數 */
        String dorm = jso.getString("dormNo");
        String room = jso.getString("roomNo");
        String bed = jso.getString("bedNo");

        
        /** 建立一個新的會員物件 */
        CheckIn c = new CheckIn(dorm, room, bed,isDamaged);
        ...
        /** 透過MemberHelper物件的checkDuplicate()檢查該會員電子郵件信箱是否有重複 */
            ...
            /** 以字串組出JSON格式之資料 */
            String resp = "{\"status\": \'400\', \"message\": \'新增表單失敗，你曾填寫過申請表！\', \'response\': \'\'}";
            /** 透過JsonReader物件回傳到前端（以字串方式） */
            jsr.response(resp, response);
        }
    }
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        CheckIn c = new CheckIn(id, isDamaged);
